...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zqn0ko.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zqn0ko.containers.anotherwebservice.com/
...
```
git clone git@github.com:NasirJaved/container-zqn0ko.git
cd container-zqn0ko
```
...
```
docker attach container-zqn0ko
```
